...
const HealthScreen = () => {
    ...
    const reminders = useSelector((state) => state.reminders.items.health || []);

    const handleAddPress = () => {
        setIsPressed(true);
        setTimeout(() => {
            setIsPressed(false);
            navigation.navigate('NewReminderScreen', { category: 'health' });
        }, 200);
    };
            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={styles.headerWrapper}>
                    ...
                    <View style={styles.centerBlock}>
                        <Text style={styles.title}>Vaccinations and health</Text>
                    </View>
